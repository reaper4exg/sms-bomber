...
def mainmenu():  
    ...
    smsrepeater.addstr(12, 4, "[ 1 ] SEND SMS")
    smsrepeater.addstr(13, 4, "[ 2 ] API SETTINGS")
    smsrepeater.addstr(14, 4, "[ 3 ] QUIT")
    ...
    try:
        ...
        if key == ord('a') or key == ord('A'):
            ...
            curses.endwin()
            print("good bye said RE70-DECEMBER...")
            sys.exit()
        else: 
            smsrepeater.refresh()
...
def smsrep():
  ...
  print (""" 
  \x1B[32m  
   ____    U _____ u  _____  ___            ____  U _____ u   ____ U _____ u  __  __     ____  U _____ u   ____     
U |  _"\ u \| ___"|/ |___ "|/ _"\  u       |  _"\ \| ___"|/U /"___|\| ___"|/U|' \/ '|uU | __")u\| ___"|/U |  _"\ u  
 \| |_) |/  |  _|"      / /| / U |/  U  u /| | | | |  _|"  \| | u   |  _|"  \| |\/| |/ \|  _ \/ |  _|"   \| |_) |/  
  |  _ <    | |___   u// /\| \// |,-./___\U| |_| |\| |___   | |/__  | |___   | |  | |   | |_) | | |___    |  _ <    
  |_| \_\   |_____|   /_/ U \___/(_/|__"__||____/ u|_____|   \____| |_____|  |_|  |_|   |____/  |_____|   |_| \_\   
  //   \\_  <<   >>  <<>>_   //             |||_   <<   >>  _// \\  <<   >> <<,-,,-.   _|| \\_  <<   >>   //   \\_  
 (__)  (__)(__) (__)(__)__) (__)           (__)_) (__) (__)(__)(__)(__) (__) (./  \.) (__) (__)(__) (__) (__)  (__) 
 
 
  SMS Repeater: github.com/reaper4exg \033[1;0m
  """)   
  try:
    ...
    while True:
      try:
        ...
        for x in range (n): 
          ...
          if z[0] == "Error":
            print("\033[1;31m== Error. Text messages not sent plzz exit the script and try again... ==\033[1;0m")
          else:
            print("\033[1;32m== All messages has been sent! may god have there soul. ==\033[1;0m")
        else:  
          f.close()
...
def hedr():
    ...
    smsrepeater.addstr(10, 4, " SMS Repeater: github.com/reaper4exg  ", curses.color_pair(1))      
    #smsrepeater.endwin()
def LogicLoop():
    mainmenu()
try:
